...
export default function Right() {
  return (
    <div className=" xl:w-2/4 lg:w-2/4 h-full bg-primary4 z-20 flex flex-col items-center justify-center w-full">
      <div className="flex flex-col gap-7 items-center justify-center w-full">
        <p className=" text-gray-800">Register now</p>
        <form className=" flex flex-col justify-center items-center w-full gap-4">
          ...
          <div className=" flex flex-col w-2/3">
            <span className=" text-gray-300 text-lg">Confirm Password</span>
            <input
              className=" px-2 py-2 text-sm border outline-none text-gray-800"
              type="password"
              placeholder="Type your Password"
